<%-- 
    Document   : newjsp8
    Created on : Mar 16, 2024, 5:31:08 PM
    Author     : kedar
--%>
...
<div id="splash">
    ...
    <hr>
    <form id="frm2" method="post" action="NewServlet8">
        <center>
            ...
            <center>
               ...
               <tr>
                    <th>
                    <td><input text="text" name="t1" placeholder="Duty Return No"><br>
                    <input type="submit" value="Duty Return"></td>
                    </th>
                </tr>
            </center>
