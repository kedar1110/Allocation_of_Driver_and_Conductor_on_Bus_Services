...
public class NewServlet6 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet rs =st.executeQuery("select * from duty");
            List dt=new ArrayList();
            while(rs.next())
            {
            dt.add(rs.getInt("DutyNo")+":"+rs.getString("DutyName")+":"+rs.getString("DutyType")+":"+rs.getString("Destination")+":"+rs.getFloat("StartTime")+":"+rs.getFloat("TravelTime"));
            }
