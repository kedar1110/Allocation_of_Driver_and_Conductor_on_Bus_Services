...
public class NewServlet4 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while(rs.next())
            {
            dt.add(rs.getInt("BusId")+":"+rs.getString("BusNo")+":"+rs.getString("BusRoute")+":"+rs.getInt("BusCapacity")+":"+rs.getString("BusModel")+":"+rs.getString("Insurance")+":"+rs.getString("DepoName")+":"+rs.getString("Status"));
            }
